...
public partial class ModeSelector : ContentView
{
    ...
    private void UpdateLightingAppearance()
    {
        ...
        LightingFrame.BackgroundColor = active ? Color.FromArgb("#26FFFFFF") : Colors.Transparent;
    ...
    private void UpdateCompositionAppearance()
    {
        ...
        CompositionFrame.BackgroundColor = active ? Color.FromArgb("#26FFFFFF") : Colors.Transparent;
